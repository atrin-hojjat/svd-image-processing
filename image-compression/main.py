...
plt.grid(True)
plt.tight_layout()
plt.savefig(os.path.join("../output", "image-comp-mse.jpg"))
...
plt.savefig(os.path.join("../output", "image-comp-mse.pgf"))
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig(os.path.join("../output", "image-comp-mse-log.jpg"))
matplotlib.rcParams.update({
    "pgf.texsystem": "xelatex",
    'text.usetex': True,
    'pgf.rcfonts': False,
...
plt.savefig(os.path.join("../output", "image-comp-mse-log.pgf"))
plt.show()
...
plt.savefig(os.path.join("../output", "image-comp-psnr.pgf"))
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig(os.path.join("../output", "image-comp-psnr-log.jpg"))
matplotlib.rcParams.update({
    "pgf.texsystem": "xelatex",
    'text.usetex': True,
    'pgf.rcfonts': False,
